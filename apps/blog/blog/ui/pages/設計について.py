...
brokerはギルドを考えるとわかりやすいと思っています

consumerが冒険者で、ギルドに貼ってあるクエストを見て、自分にできるクエストを選んでやる感じです

また、冒険者はできるところだけやってギルドに残りをproduce(丸投げ)することもあります
...
物理的にイベントソーシングしたら家がゴミ屋敷になりますが、特にテキストデータなどの情報というのは誤差と言えるほどデータが小さいため、一生のうちに考えたすべての内容をイベントとして記録しても、普通にprojectionできると思っています
